...
# Block everything without social media and porn sites.

curl "https://raw.githubusercontent.com/StevenBlack/hosts/master/alternates/gambling/hosts" --output hosts00001.txt && \
